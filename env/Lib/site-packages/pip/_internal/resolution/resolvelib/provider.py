...
#
# The provider is a direct implementation of the resolution class. Its role
# is to deliver the API that resolution expects.
#
# Rather than work with completely abstract "requirement" and "candidate"
# concepts as resolution does, pip has concrete classes implementing these two
...
class PipProvider(_ProviderBase):
    """Pip's provider implementation for resolution.
